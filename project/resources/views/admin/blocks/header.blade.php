          ...
          <ul class="nav nav-secondary">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebarLayouts">
                <ul class="nav nav-collapse">
                  <li>
                    <a href="{{route('admin.orderd')}}">
                      <span class="sub-item">Đơn hàng mới</span>
                    </a>
                  </li>
                  <li>
                    <a href="{{route('admin.orderd.momo')}}">
                      <span class="sub-item">Đơn hàng thanh toán Momo</span>
                    </a>
                  </li>
                  <li>
                    <a href="{{route('admin.orderd.destroy')}}">
                      <span class="sub-item">Đơn hủy</span>
                    </a>
                  </li>
                </ul>
              </div>
